...
for (i in seq_along(all_folders)){
  ...
  for (j in 1:1){
    ...
    sim <- readRDS(str_c("../data/", all_folders[i], "/", files[j]))
    ...
    write (str_c("made it past weibull fit for sim  ", i, "df ", j), file = "../output/do_sim_output.txt")
    ...
    print("period 1")
    print(log_quad_pars$weight[log_quad_pars$period == 1])
    print("period 2")
    print(log_quad_pars$weight[log_quad_pars$period == 2])
    print("period 3")
    print(log_quad_pars$weight[log_quad_pars$period == 3])
    print("period 4")
    print(log_quad_pars$weight[log_quad_pars$period == 4])
    print("period 5")
    print(log_quad_pars$weight[log_quad_pars$period == 5])
    ...
    print("period 1")
    print(log_quad_pars_adj$weight[log_quad_pars_adj$period == 1])
    print("period 2")
    print(log_quad_pars_adj$weight[log_quad_pars_adj$period == 2])
    print("period 3")
    print(log_quad_pars_adj$weight[log_quad_pars_adj$period == 3])
    print("period 4")
    print(log_quad_pars_adj$weight[log_quad_pars_adj$period == 4])
    print("period 5")
    print(log_quad_pars_adj$weight[log_quad_pars_adj$period == 5])
    
    sum(log_quad_pars_adj$weight[log_quad_pars_adj$period == 5])
    #Looping through each period
    for (w in 1:5){
