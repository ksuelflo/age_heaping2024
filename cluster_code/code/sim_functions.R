...
library(survival, lib.loc = "/panfs/jay/groups/36/okone006/shared/R/x86_64-pc-linux-gnu-library/4.4")
library(dplyr, lib.loc = "/panfs/jay/groups/36/okone006/shared/R/x86_64-pc-linux-gnu-library/4.4")
library(flexsurv, lib.loc = "/panfs/jay/groups/36/okone006/shared/R/x86_64-pc-linux-gnu-library/4.4")
library(knitr, lib.loc = "/panfs/jay/groups/36/okone006/shared/R/x86_64-pc-linux-gnu-library/4.4")
library(pssst, lib.loc = "/panfs/jay/groups/36/okone006/shared/R/x86_64-pc-linux-gnu-library/4.4")
library(logquad5q0, lib.loc = "/panfs/jay/groups/36/okone006/shared/R/x86_64-pc-linux-gnu-library/4.4")
library(SUMMER, lib.loc = "/panfs/jay/groups/36/okone006/shared/R/x86_64-pc-linux-gnu-library/4.4")
library(tidyr, lib.loc = "/panfs/jay/groups/36/okone006/shared/R/x86_64-pc-linux-gnu-library/4.4")
library(stringr, lib.loc = "/panfs/jay/groups/36/okone006/shared/R/x86_64-pc-linux-gnu-library/4.4")
library(withr, lib.loc = "/panfs/jay/groups/36/okone006/shared/R/x86_64-pc-linux-gnu-library/4.4")
...
get_uncertainty_surv_synthetic <- function(res_surv_synthetic,
  ...
  #print(str_c("means = ", means))
  #print(str_c("variance = ", var_est))
  
  # sample from multivariate normal
  samps <- MASS::mvrnorm(n = 1000, mu = means, Sigma = var_est)
  
  #print(str_c("samps = ", head(samps)))
  ...
  #print(str_c("n_periods = ", n_periods))
  ...
  if (distribution == "lognormal") {
    ...
    for (i in 1:nrow(samps)) {
      ...
      if (i == 1){
       # print(str_c("log_sigma_ests = ", log_sigma_ests))
       # print(str_c("log_1overmu_ests = ", log_1overmu_ests))
      }
